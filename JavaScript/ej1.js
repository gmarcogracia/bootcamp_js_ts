...
function createObject(id,name,surname,gender,email,picture){

  return {id:id,name:name,surname:surname,gender:gender,email:email,picture:picture}
...
  let tempArray=dataCopy[i].split(",");
 // console.log(tempArray);
  returnArray.push(
    createObject(...tempArray)
